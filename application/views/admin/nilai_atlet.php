          ...
          <div class="row">
            <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                  <form action="<?=base_url('admin/nilai_atlet')?>" method = "GET">
                    <div class="row">
                      <div class="col-4"> 
                              ...
                              ?>
                                   ...
                                   $jum = $jum + 2;
                                      ...
                                      <td rowspan="<?=$jum?>">
                                        ...
                                        <a href="<?=base_url('admin/delete_nilai')?>/<?= $na['atlet_id'] ?>"><button class="btn btn-danger" onclick="return confirm('Yakin Mau Hapus??')">Hapus</button></a>
                                      </td>
                                      <?php  
